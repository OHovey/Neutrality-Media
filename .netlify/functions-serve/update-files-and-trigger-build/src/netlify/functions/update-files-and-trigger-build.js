...
// node_modules/@netlify/functions/node_modules/is-promise/index.js
var require_is_promise = __commonJS({
  "node_modules/@netlify/functions/node_modules/is-promise/index.js"(exports, module2) {
...
// netlify/functions/update-files-and-trigger-build.ts
var update_files_and_trigger_build_exports = {};
__export(update_files_and_trigger_build_exports, {
  handler: () => handler
});
...
var fetchHeadline = async (term) => {
  return await import_axios.default.post("https://api.openai.com/v1/completions", {
    "model": "text-ada-001",
...
var myHandler = async (event, context) => {
  ...
  const result = await import_axios.default.get("https://api.apify.com/v2/actor-tasks/VncdzeYjbYNubPpkY/runs/last/dataset/items?token=apify_api_FpKFZk1nVdehSrF7HedZ8x7Cqxdnzp0T4bhK&status=SUCCEEDED", {
    headers: {
      "Content-Type": "application/json"
    }
  }).catch((err) => {
  ...
  await Promise.all(querys.map(async (term) => {
    ...
    Object.keys(articles).map(async (articleTitle) => {
      ...
      import_fs.default.writeFileSync(`${title}.md`, `# ${articleTitle}`);
      import_fs.default.appendFileSync(`${title}.md`, `# ${articles[articleTitle]}`);
      const fileContent = import_fs.default.readFileSync(`${title}`).toString("base64");
      const config = {
        headers: {
      ...
      import_fs.default.unlinkSync(title);
      try {
        const response = await import_axios.default.put(`https://api.github.com/repos/${repository}/src/data/articles/${title}`, {
...
var handler = (0, import_functions.schedule)("@daily", myHandler);
module.exports = __toCommonJS(update_files_and_trigger_build_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  handler
});
//# sourceMappingURL=update-files-and-trigger-build.js.map
