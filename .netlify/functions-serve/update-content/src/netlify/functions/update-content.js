...
// netlify/functions/update-content.ts
var update_content_exports = {};
__export(update_content_exports, {
  handler: () => handler
});
...
var myHandler = async (event, context) => {
  ...
  const result = await import_axios.default.get("https://api.apify.com/v2/acts/actorId/runs/last/?actorTaskId=VncdzeYjbYNubPpkY&token=apify_api_FpKFZk1nVdehSrF7HedZ8x7Cqxdnzp0T4bhK", {
    headers: {
      "Content-Type": "application/json"
    }
  }).catch((err) => {
...
module.exports = __toCommonJS(update_content_exports);
