...
// netlify/functions/query-keywords.ts
var query_keywords_exports = {};
__export(query_keywords_exports, {
  handler: () => handler
});
...
module.exports = __toCommonJS(query_keywords_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  handler
});
//# sourceMappingURL=query-keywords.js.map
